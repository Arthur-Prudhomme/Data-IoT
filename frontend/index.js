...
socket.on("direction", (data) => {
    console.log(data)
    var key = data;
    if(key == "left" && dir !== "right"){ setTimeout(function(){ dir = "left"; }, 30) }
    if(key == "up" && dir !== "down"){ setTimeout(function(){ dir = "up"; }, 30) }
    if(key == "right" && dir !== "left"){ setTimeout(function(){ dir = "right"; }, 30) }
